...
fbref_urls = ['https://fbref.com/en/squads/18bb7c10/Arsenal-Stats', 'https://fbref.com/en/squads/b8fd03ef/Manchester-City-Stats', 'https://fbref.com/en/squads/b2b47a98/Newcastle-United-Stats', 'https://fbref.com/en/squads/361ca564/Tottenham-Hotspur-Stats', 'https://fbref.com/en/squads/19538871/Manchester-United-Stats', 'https://fbref.com/en/squads/822bd0ba/Liverpool-Stats', 'https://fbref.com/en/squads/d07537b9/Brighton-and-Hove-Albion-Stats', 'https://fbref.com/en/squads/cff3d9bb/Chelsea-Stats', 'https://fbref.com/en/squads/fd962109/Fulham-Stats', 'https://fbref.com/en/squads/cd051869/Brentford-Stats', 'https://fbref.com/en/squads/47c64c55/Crystal-Palace-Stats', 'https://fbref.com/en/squads/8602292d/Aston-Villa-Stats', 'https://fbref.com/en/squads/a2d435b3/Leicester-City-Stats', 'https://fbref.com/en/squads/4ba7cbea/Bournemouth-Stats', 'https://fbref.com/en/squads/5bfb9659/Leeds-United-Stats', 'https://fbref.com/en/squads/7c21e445/West-Ham-United-Stats', 'https://fbref.com/en/squads/d3fd31cc/Everton-Stats', 'https://fbref.com/en/squads/e4a775cb/Nottingham-Forest-Stats', 'https://fbref.com/en/squads/33c895d4/Southampton-Stats', 'https://fbref.com/en/squads/8cec06e1/Wolverhampton-Wanderers-Stats']
...
def scrape_player_values():
    ...
    #         player_list.append([name, country, pos, values[i]])
...
def scrape_player_stats():
    ...
    for i, url in enumerate(fbref_urls):
...
if __name__ == '__main__':
    if len(sys.argv) > 1 and sys.argv[1] == 'value':
        ...
        df = pd.DataFrame(value_info, columns=['name', 'country', 'position', 'value'])
        df.to_csv('value_info.csv', index=False)

    if len(sys.argv) > 1 and sys.argv[1] == 'stats':
        stat_info = scrape_player_stats()
        df = pd.DataFrame(stat_info, columns=['name', 'country', 'goals', 'assists', 'xg', 'xa', 'npxg_xa'])
